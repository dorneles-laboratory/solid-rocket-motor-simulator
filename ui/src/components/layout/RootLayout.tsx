...
import { 
  ...
  Sliders as IconBoundary,
  FileText as IconReports,
  Rocket as IconPropellants,
  Layers as IconStructural,
  Thermometer as IconThermal,
  Cog as IconMotors,
  Files as IconDocuments,
...
const VIEW_CONFIG: Record<string, { title: string; icon: React.ReactNode }> = {
  ...
  "geometry-editor": { title: "Editor de Geometria", icon: <IconGeometry /> },
  "boundary-conditions": { title: "Condições de Contorno", icon: <IconBoundary /> },
  "reports": { title: "Relatórios", icon: <IconReports /> },
